...
$dir =  '/usr/share/nginx/html/build/storage/orders/rcdm/';
...
{
    return
    "<tr><td style='text-align:left;'><a href='/storage/orders/rcdm/" . $name_with_ext. "'>" . $name . "</a></td><td>" . "Дата загрузки файлов: " . date('d.m.Y H:i:s.', $date_of_create) . "</td></tr>". PHP_EOL;
}
?>
